...
if (lineOn === lineOff)
        ...
        if (start === allLinesArr[i][j])
          ...
          for (var k = 0; k<allLinesArr[i].length; k++)
            ...
            if (lineOn === allLinesArr[i][0] && start === allLinesArr[i][j] && finish === allLinesArr[i][k])
              {
              console.log("You must travel through the following stops on the " + lineOn + " line: " + //allLinesArr[i].slice(startIndex,finishIndex)
              sliceArr + " and get out at " + finish +" on the " +lineOff+" line. "+ ((finishIndex-startIndex)+1) +" stops in total.");
  ...
  for (var l = 0; l < allLinesArr.length; l++)
  {if (lineOff === allLinesArr[l][0])
      var unionSquareIndex = (allLinesArr[l].indexOf("Union Square"));
      var finishIndex = (allLinesArr[l].indexOf(finish));
      var twoLineslice = allLinesArr[l].slice(unionSquareIndex,finishIndex)
      var numberOfStops = ((finishIndex-startIndex)+1)
...
if (lineOn === lineOff)
  ...
  for (var l = 0; l < allLinesArr.length; l++)
  {if (lineOff === allLinesArr[l][0])
      var unionSquare = (allLinesArr[l].indexOf("Union Square"));
      var finishIndex = (allLinesArr[l].indexOf(finish));
      var twoLineslice = allLinesArr[l].slice[startIndex,finishIndex]

  console.log("You must travel through the following stops on the " + lineOn + " line and get off and change to the " + lineOff  + " line at Union Square. Here change to the " + lineOff + " ")}
}
  }//for every key in allLinesArr
